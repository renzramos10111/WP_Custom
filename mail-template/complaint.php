...
class CustomMailSetup{
	...
	/* Templates */
	function complaint_email($to, $subject,$id){
		
		$header = $this->header($subject);
		$footer = $this->footer($subject);
		$content = '
    ...
    width: 211px;
    display: block;
    margin: 0 auto;" src="http://searchengineland.com/figz/wp-content/seloads/2016/01/bing-new-logo-1920-800x338.jpg">Hi there,</p>
						...
						<table class="btn-primary" cellpadding="0" cellspacing="0" border="0">
						  <tr>
							<td>
							  <a href="' . get_edit_post_link($id) . '">View the source and instructions on GitHub</a>
							</td>
						  </tr>
						</table>
						<!-- /button -->
