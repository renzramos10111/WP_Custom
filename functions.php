...
function foobar_func( $atts ){
	...
	//echo "test";
	//echo "<frame src='" . $atts["url"] .  "'></iframe>";
}
...
class MySettingsPage
{
    ...
    public function create_admin_page()
    {
        ...
        <div class="wrap">
            ...
            <?php
				...
				//$xml=simplexml_load_file($option_name["title"]) or die("Error: Cannot create object");
				...
				if ( $query->have_posts() ) {
					?>
					<select name="my_option_name[title]">
					<?php
					while ( $query->have_posts() ) {
						$query->the_post();
						?>
						
						<option value="<?php echo $option_name['title'].  get_the_title(); ?>" <?php selected( $option_name['title'], get_the_title()); ?>><?php echo get_the_title() ; ?></option>
				...
				<table class="widefat fixed" cellspacing="0">
					...
					<tr>
							...
							<th id="cb" class="manage-column column-cb" scope="col"></th> // this column contains checkboxes
    ...
    <tbody>
				...
				<tr class="alternate" valign="top"> 
					<td class="column-columnname"><?php echo $item->title;  ?></td>
					<td class="column-columnname"><?php echo $item->description;  ?></td>
					<td class="column-columnname">sdfsd</td>
				</tr>
				<?php
				}
            ?>
...
/**
 * Or create a shortcode, this way you will be able to use the shortcode [mailpoet_subscription_link]
